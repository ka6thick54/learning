# Problem statement: Find If the array has a pair of integers that sum to the
# value provided
...
# Time complexity O(n) explanation: We are using set as the time complexity of
# find an element in a set in constant O(1)
